...
export const MENU_PERMISSIONS = {
  ...
  SPECIALITY_PRODUCT: "product-speciality",
  FILES: "files",
...
export const MENU_ITEMS = [
  ...
  { value: MENU_PERMISSIONS.SPECIALITY_PRODUCT, label: "Speciality Product" },
  { value: MENU_PERMISSIONS.FILES, label: "Files" },
  { value: MENU_PERMISSIONS.PROJECTS_MENU, label: "Projects" },
  { value: MENU_PERMISSIONS.PROJECTS_CATEGORIES, label: "Project Categories" },

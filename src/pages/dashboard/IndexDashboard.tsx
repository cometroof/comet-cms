      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Manage your roofing company website content, articles, products, and
            more with our comprehensive CMS solution.
          </p>
        ...
        <div className="text-center text-muted-foreground">
          <p>
            © 2024 Roofing Company CMS. Professional content management for
            roofing businesses.
          </p>
        </div>
      </div>

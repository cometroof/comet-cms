...
const ProfileDetailPage = () => {
  ...
  const handleBackClick = () => {
    navigate(`/dashboard/product-speciality/${productId}`);
  };
  ...
  const handleViewCategory = (category: ProductCategory) => {
    navigate(
      `/dashboard/product-speciality/${productId}/profile/${profileId}/category/${category.id}`
    );
  };
  ...
  const handleEditProfile = () => {
    navigate(`/dashboard/product-speciality/${productId}/profile/${profileId}/edit`);
  };
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          <button
            onClick={() => navigate("/dashboard/product-speciality")}
